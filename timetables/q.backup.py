...
os.system("wget -O table.xlsx http://webservices.mirea.ru/upload/iblock/9a5/%D0%9A%D0%91%D0%B8%D0%A1%D0%9F%201%20%D0%BA%D1%83%D1%80%D1%81%201%20%D1%81%D0%B5%D0%BC.xlsx")
out_red("Завершено!")
...
for week in range(2):
	...
	for  prefix in prefixs:
		...
		out_red("Создание расписание для группы:"+str(prefix))
		for i in range(4,76):
			w +=1
